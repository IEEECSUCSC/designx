        ...
        <main className="relative flex w-full flex-1 flex-col items-center">
            <section className="relative flex w-full max-w-5xl flex-1 flex-col items-center justify-center pt-10 text-center">
                ...
                <p className="body-copy mx-auto mt-8 max-w-3xl text-[12px] leading-5 text-zinc-800">
                    This is the official certificate verification page for the
                    UI/UX Design Workshop organized by the IEEE Computer Society
                    Student Branch - University of Colombo School of Computing
                    (UCSC), with IFS as the Innovation Partner. Use this page to
                    verify the authenticity of certificates issued for this
                    workshop using the unique verification code provided on each
                    certificate.
                </p>
