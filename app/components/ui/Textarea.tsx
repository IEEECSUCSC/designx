...
export default function Textarea(
  ...
  return (
    <textarea
      {...props}
      className={cn(
        "w-full appearance-none px-4 py-2 transition-[transform_shadow] duration-300 will-change-transform outline-none lg:min-w-[24rem]",
        ...
        "placeholder:text-foreground/50 bg-background",
      )}
    />
  );
}
